...
{
    public class ChangeQuantityProcess
    {
        ...
        public static string excuteProcessRefund(PosModel posModel, InputModel inputModel, InformationModel informationModel)
        {
            ...
            if (!string.IsNullOrEmpty(inputModel.EnteredText))
            {
                ...
                quantity = int.Parse(inputModel.EnteredText);
        ...
        public static bool checkStockProcess(PosModel posModel, double quantity)
        {
            ...
            // 2021.2.23 : NON VAT
            if (posModel.Environment.EnvPosSetup.NonVAT) return true;
        ...
        public static bool checkStockProcess(PosModel posModel, ItemNode itemNode, double quantityAdd)
        {
            // 2021.2.23 : NON VAT
            if(posModel.Environment.EnvPosSetup.NonVAT) return true;
