...
namespace EBM2x.UI.Backoffice.StockManagement
{
    ...
    public partial class StockInHistoryPage : ContentPage
    {
        ...
        StockInHistoryMaster master = null;
        OpeningCloseingStockRecord record = null;
        public StockInHistoryPage()
        {
            ...
            master = new StockInHistoryMaster();
        ...
        protected override void OnAppearing()
        {
            ...
            listOpeningCloseingStockRecord = master.getStockInHistoryTable(fromStr, toStr, etLikeValue.GetEntryValue());
        ...
        async void OnFunctionExport(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (iSave != null)
                {
                    ...
                    await iSave.SaveAndView("StockInHistory_" + dt + ".xlsx", "", stream);
