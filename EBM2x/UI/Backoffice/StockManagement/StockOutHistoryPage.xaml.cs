...
namespace EBM2x.UI.Backoffice.StockManagement
{
    ...
    public partial class StockOutHistoryPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            listOpeningCloseingStockRecord = master.getStockOutHistoryTable(fromStr, toStr, etLikeValue.GetEntryValue());
        ...
        async void OnFunctionExport(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (iSave != null)
                {
                    ...
                    await iSave.SaveAndView("StockOutHistory_" + dt + ".xlsx", "", stream);
