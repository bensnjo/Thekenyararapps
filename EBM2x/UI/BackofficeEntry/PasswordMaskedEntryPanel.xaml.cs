...
namespace EBM2x.UI.BackofficeEntry
{
    ...
    public partial class PasswordMaskedEntryPanel : ContentView
    {
        ...
        public static readonly BindableProperty BorderColorProperty = BindableProperty.Create(
                                                         ...
                                                         declaringType: typeof(PasswordMaskedEntryPanel),
                                                         defaultValue: "000000",
        ...
        public PasswordMaskedEntryPanel()
        {
            InitializeComponent();
            entryFixedGrid.InitializeComponent();

            entryEntry.IsPassword = true;
        }
