...
namespace EBM2x.UI.BackofficeEntry
{
    ...
    public partial class RcptTypePickerEntryPanel : ContentView
    {
        ...
        public static readonly BindableProperty BorderColorProperty = BindableProperty.Create(
                                                         ...
                                                         declaringType: typeof(RcptTypePickerEntryPanel),
                                                         defaultValue: "000000",
        ...
        public RcptTypePickerEntryPanel()
        {
            InitializeComponent();
            entryFixedGrid.InitializeComponent();

            pickerList = new List<SystemCode>();
            pickerList.Add(new SystemCode() { Id = "A", Name = "All" });
            pickerList.Add(new SystemCode() { Id = "S", Name = "Normal sales" });
            pickerList.Add(new SystemCode() { Id = "R", Name = "Refund sales" });
