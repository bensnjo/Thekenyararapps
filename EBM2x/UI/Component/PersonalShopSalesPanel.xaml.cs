...
namespace EBM2x.UI.Component
{
    ...
    public partial class PersonalShopSalesPanel : ContentView
    {
        List<PhoneSalesItemView> SalesItemViewList = null;

        public PersonalShopSalesPanel()
        {
            InitializeComponent();

            SalesItemViewList = new List<PhoneSalesItemView>();
