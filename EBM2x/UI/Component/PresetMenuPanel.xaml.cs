...
namespace EBM2x.UI.Component
{
    ...
    public partial class PresetMenuPanel : ContentView
    {
        ...
        public static readonly BindableProperty FunctionCalledProperty = BindableProperty.Create(
                                                         ...
                                                         declaringType: typeof(PresetMenuPanel),
                                                         defaultValue: null,
                                                         defaultBindingMode: BindingMode.OneWay);

        List<PresetGroupButton> PresetGroupButtonList = null;
        List<PresetItemButton> PresetItemButtonList = null;

        public PresetMenuPanel()
        {
            InitializeComponent();

            fixedGrid.InitializeComponent();

            PresetGroupButtonList = new List<PresetGroupButton>();
            for (int i = 0; i < 5; i++)
            {
                PresetGroupButton presetGroupButton = new PresetGroupButton
                {
            ...
            PresetItemButtonList = new List<PresetItemButton>();
            for (int k = 0; k < 3; k++)
            {
                for (int i = 0; i < 5; i++)
                {
                    PresetItemButton presetItemButton = new PresetItemButton
                    {
            ...
            fixedGrid.Children.Add(imageButton, 0, 1, 5, 10);
            ...
            fixedGrid.Children.Add(imageButton, 19, 20, 5, 10);
        }
