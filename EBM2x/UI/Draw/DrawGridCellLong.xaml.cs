...
namespace EBM2x.UI.Draw
{
	...
	public partial class DrawGridCellLong : ContentView
	{
        public string Text
        {
            get {
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create(
                                                         ...
                                                         declaringType: typeof(DrawGridCellLong),
                                                         defaultValue: "0",
        ...
        private void OnPainting(object sender, SKPaintSurfaceEventArgs e)
        {
            ...
            {
                DrawTools.PaintSurfaceAppend(e.Surface.Canvas, e.Info.Width, e.Info.Height, "0", FillRate, TextAlign, SKColor.Parse(TextColor));
            }
