...
namespace EBM2x.UI.Draw
{
	...
	public partial class PinwheelView : ContentView
	{
        SKBitmap bitmapPinwheelx = null;
        bool pageIsActive;
        ...
        public PinwheelView()
        {
            ...
            using (var stream = ResourceUtil.GetImageStream("pinwheelx.png"))
            {
                bitmapPinwheelx = SKBitmap.Decode(stream);
            }
        ...
        {
            PaintSurface(e.Surface.Canvas, angle, e.Info.Width, e.Info.Height, bitmapPinwheelx);
        }
