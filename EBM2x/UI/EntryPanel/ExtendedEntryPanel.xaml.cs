...
namespace EBM2x.UI.EntryPanel
{
    ...
    public partial class ExtendedEntryPanel : ContentView
    {
        public string Text
        {
        ...
        public static readonly BindableProperty TextProperty = BindableProperty.Create(
                                                         ...
                                                         declaringType: typeof(ExtendedEntryPanel),
                                                         defaultValue: string.Empty,
                                                         defaultBindingMode: BindingMode.TwoWay);
        public ExtendedEntryPanel()
        {
            InitializeComponent();
        ...
        {
             (sender as Entry).Text = e.NewTextValue;
        }
