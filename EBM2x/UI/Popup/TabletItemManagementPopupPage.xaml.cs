...
namespace EBM2x.UI.Popup
{
    ...
    public partial class TabletItemManagementPopupPage : ContentPage
    {
        ...
        public TabletItemManagementPopupPage()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            entityItemCode.SetReadOnly(true);
        ...
        async void OnSaveButtonClicked(object sender, EventArgs e)
        {
            ...
            string locationMessage = UILocation.Instance().GetLocationText("Do you want to save this Item?");
        ...
        {
            var popupPage = new TabletSearchClassPopupPage();
            popupPage.SetValue(NavigationPage.HasNavigationBarProperty, false);
        ...
        {
            var popupPage = new TabletSearchOriginPopupPage();
            popupPage.SetValue(NavigationPage.HasNavigationBarProperty, false);
