...
namespace EBM2x.UI.Tablet.Menu
{
    ...
    public partial class RestaurantAdminMenuPage : ContentPage
    {
        public RestaurantAdminMenuPage()
        {
        ...
        async void OnFunctionCalled(object sender, EventArgs e)
        {
            ...
            switch (((ExtEventArgs)e).FunctionID)
            {
                ...
                case "DiningTableManagement":
                    await Navigation.PushAsync(new DiningTableManagementPage());
                    break;
