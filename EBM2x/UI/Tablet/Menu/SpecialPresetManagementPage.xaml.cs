...
namespace EBM2x.UI.Tablet.Menu
{
    ...
    public partial class SpecialPresetManagementPage : ContentPage
    {
        ...
        public SpecialPresetManagementPage()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            imagePresetMenuPanel.PresetGroupListInvalidateSurface(UIManager.Instance().PosModel.PresetModel.PresetGroupList, true, true);
        }
        ...
        void Subscribe()
        {
            ...
            MessagingCenter.Subscribe<Object, PresetGroupList>(this, "Preset Group Node", (sender, arg) => {
                Device.BeginInvokeOnMainThread(() => {
                    imagePresetMenuPanel.PresetGroupListInvalidateSurface(arg, true, true);
                });
            });

            MessagingCenter.Subscribe<Object, PresetItemList>(this, "Preset Item Node", (sender, arg) => {
                Device.BeginInvokeOnMainThread(() => {
                    imagePresetMenuPanel.PresetItemListInvalidateSurface(arg, true, true);
                });
            });
        ...
        async void OnFunctionCalled(object sender, EventArgs e)
        {
            ...
            switch (((ExtEventArgs)e).FunctionID)
            {
                ...
                case "DeleteGroup":
                    ...
                    break;
                case "AddItem":
                    string locationTitle7 = UILocation.Instance().GetLocationText("Add?");
                    string locationMessage7 = UILocation.Instance().GetLocationText("Are you sure?");
                    var resultAddItem = await DisplayAlert(locationTitle7, locationMessage7, "Yes", "No");
                    if (resultAddItem)
                    {
                        if (PresetGroupNode != null)
                        {
                    ...
                    break;
                case "DeleteItem":
                    string locationTitle8 = UILocation.Instance().GetLocationText("Delete?");
                    string locationMessage8 = UILocation.Instance().GetLocationText("Are you sure?");
                    var resultDeleteItem = await DisplayAlert(locationTitle8, locationMessage8, "Yes", "No");
                    if (resultDeleteItem)
                    {
                        if (PresetGroupNode != null)
                        {
