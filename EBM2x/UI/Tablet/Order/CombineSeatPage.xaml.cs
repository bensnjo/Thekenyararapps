...
namespace EBM2x.UI.Tablet.Order
{
    ...
    public partial class CombineSeatPage : ContentPage
    {
        ...
        protected override void OnAppearing()
        {
            ...
            UIManager.Instance().PosModel.SetSalesTitleText("Combine a seat");
