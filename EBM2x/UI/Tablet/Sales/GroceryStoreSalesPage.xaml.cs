...
namespace EBM2x.UI.Tablet.Sales
{
    ...
    public partial class GroceryStoreSalesPage : ContentPage
    {
        bool IsEnteredItem = false;

        public GroceryStoreSalesPage()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            {
                Navigation.InsertPageBefore(new GroceryStoreRefundSalesPage(), this);
                Navigation.PopAsync();
            }
            ...
            UIManager.Instance().PosModel.SetSalesTitleText("Sales");
        ...
        async void OnFunctionCalled(object sender, EventArgs e)
        {
            ...
            switch (((ExtEventArgs)e).FunctionID)
            {
                ...
                case "Quantity":
                    ...
                    bool stockCheck = ChangeQuantityProcess.checkStockProcess(UIManager.Instance().PosModel, qty);
                    if (!stockCheck)
                    {
                        EBM2x.UI.UiUtils.MsgBox.DisplayAlert(this, "Confirm", "Sales quantity is greater than current stock quantity.", "Ok");
                        UIManager.Instance().InputModel.Clear();
