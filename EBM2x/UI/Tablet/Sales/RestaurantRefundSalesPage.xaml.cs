...
namespace EBM2x.UI.Tablet.Sales
{
    ...
    public partial class RestaurantRefundSalesPage : ContentPage
    {
        bool IsEnteredItem = false;

        public RestaurantRefundSalesPage()
        {
        ...
        protected override void OnAppearing()
        {
            ...
            UIManager.Instance().PosModel.SetSalesTitleText("Restaurant|Refund");
